...
if ((selected_category == "Potions") && (M5Cardputer.Keyboard.isKeyPressed(';')) || ((selected_category == "Potions") && (M5Cardputer.Keyboard.isKeyPressed('.')))) {selected_category = "Weapons";}

if ((selected_category == "Potions") && (M5Cardputer.Keyboard.isKeyPressed('s')) || ((selected_category == "Potions") && (M5Cardputer.Keyboard.isKeyPressed('e')))) {selected_category = "Weapons";}


// v CHANGE LV IF CATEGORY IS WEAPONS OR ARMOR v

if ((M5Cardputer.Keyboard.isKeyPressed('=')) && (selected_category == "Weapons") || (M5Cardputer.Keyboard.isKeyPressed('=')) && (selected_category == "Armor")) {selected_category = categories[1]; current_party_index = current_party_index + 1; delay(250); levelChanger();}

  else if ((M5Cardputer.Keyboard.isKeyPressed('-')) && (selected_category == "Weapons") || (M5Cardputer.Keyboard.isKeyPressed('-')) && (selected_category == "Armor")) {selected_category = categories[1]; current_party_index = current_party_index - 1; delay(250); levelChanger();}
